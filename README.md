...
### Piano Input
[piano.mov](demo/piano.mov)

### Drum Pads
[drum.mov](demo/drum.mov)

### Equalizer Control
[equalizer.mov](demo/equalizer.mov)

> You can download or preview these `.mov` files depending on your browser or GitHub client.
